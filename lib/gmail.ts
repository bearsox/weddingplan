...
export async function fetchGmailMessages(
  ...
  const weddingQuery = query || 'wedding OR venue OR catering OR photographer OR florist OR "save the date" OR RSVP OR reception OR bridal OR engaged OR engagement'
